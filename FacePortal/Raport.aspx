...
&nbsp;&nbsp;&nbsp;
      <asp:Label ID="name_value" runat="server" Text="Label" Visible="False"></asp:Label>
      <br />
      <asp:Label ID="Surname" runat="server" Text="Surname" Visible="False"></asp:Label>
&nbsp;&nbsp;&nbsp;
      <asp:Label ID="surname_value" runat="server" Text="Label" Visible="False"></asp:Label>
    <br />
      <br />
